...
__all__ = [
    'DISPID_SRCResume', 'SVP_17', 'SPPS_SuppressWord',
    'DISPID_SRGCmdLoadFromFile', 'SECFEmulateResult',
    'SpeechBookmarkOptions', 'DISPID_SOTGetDescription',
    'SPEVENTSOURCEINFO', 'SDTPronunciation',
    'SpeechCategoryRecoProfiles', 'SWTAdded', 'SRSInactiveWithPurge',
    'eLEXTYPE_PRIVATE15', 'SVP_18', 'eLEXTYPE_PRIVATE20',
    'SAFT24kHz8BitStereo', 'SpeechVisemeFeature',
    'SpeechDisplayAttributes', 'SPCS_DISABLED', 'DISPID_SLWsCount',
    'SPEI_END_INPUT_STREAM', 'SPDKL_CurrentConfig',
    'DISPID_SRRSpeakAudio', 'SPEI_WORD_BOUNDARY', 'SPGS_ENABLED',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPSFunction',
    'DISPID_SLPs_NewEnum', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechPhraseAlternate', 'DISPID_SASNonBlockingIO',
    'ISpeechMMSysAudio', 'DISPID_SPPChildren',
    'DISPID_SWFEBlockAlign', 'SpeechAudioProperties', 'SGSDisabled',
    'SFTSREngine', 'SpeechVoiceCategoryTTSRate',
    'SVSFParseAutodetect', 'DISPID_SPEDisplayAttributes',
    'SpSharedRecognizer', 'eLEXTYPE_RESERVED4', 'ISpRecoResult',
    'SPAR_Unknown', 'DISPID_SRRTOffsetFromStart', 'SpMMAudioEnum',
    'SAFTNoAssignedFormat', 'ISpRecoContext2',
    'ISpeechPhraseElements', 'SREPhraseStart', 'STCAll',
    'DISPID_SLGetGenerationChange', 'IStream',
    'DISPID_SPIEnginePrivateData', 'SPEI_RESERVED3', 'SpFileStream',
    'SREPrivate', 'SAFTADPCM_22kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVEStreamEnd',
    'DISPID_SRRRecoContext', 'SSSPTRelativeToEnd',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPERetainedSizeBytes',
    'SGRSTTRule', 'SPAUDIOBUFFERINFO',
    'SpeechRegistryLocalMachineRoot', 'SDTAlternates',
    'DISPID_SVPriority', 'SpeechGrammarWordType',
    'SpeechAudioFormatGUIDWave', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SDKDeleteKey', 'SSTTTextBuffer', 'DISPID_SGRAttributes',
    'DISPID_SpeechLexiconProns', 'DISPID_SFSClose',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SLWWord', 'DISPID_SGRSTType',
    'SPLO_STATIC', 'SAFTGSM610_8kHzMono', 'DISPID_SPRuleName',
    'SPEI_MIN_TTS', 'SFTInput', 'DISPID_SRGetPropertyNumber',
    'SPCT_DICTATION', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLPSymbolic', 'DISPID_SRCERequestUI', 'SPAS_STOP',
    ...
    'DISPID_SPIGrammarId', 'SINoise', 'eLEXTYPE_PRIVATE18',
    'SP_VISEME_16', 'ISpeechBaseStream', 'DISPID_SADefaultFormat',
    '__MIDL_IWinTypes_0009', 'SP_VISEME_8',
    'SPEI_PROPERTY_STRING_CHANGE', 'SSSPTRelativeToCurrentPosition',
    'eLEXTYPE_PRIVATE14', 'DISPID_SGRInitialState', 'SPEI_MIN_SR',
    'ISpMMSysAudio', 'DISPID_SDKDeleteValue', 'ISpResourceManager',
    'DISPID_SPIAudioSizeTime', 'ISpRecognizer', 'SPEI_SOUND_START',
    'SECFIgnoreCase', 'SRTStandard', 'SPGS_EXCLUSIVE',
    'SPGS_DISABLED', 'SGLexicalNoSpecialChars', 'SPINTERFERENCE',
    'SVSFParseSapi', 'eWORDTYPE_ADDED', 'DISPID_SPRFirstElement',
    'SSFMOpenForRead', 'DISPID_SpeechPhraseProperties',
    'DISPID_SLPLangId', 'SPVPRI_ALERT', 'SINoSignal',
    'ISpeechPhraseProperty', 'SSTTDictation', 'DISPID_SGRSRule',
    'SpCompressedLexicon', 'DISPID_SRSCurrentStreamNumber',
    'SAFT22kHz16BitStereo', 'DISPID_SVIsUISupported', 'DISPIDSPTSI',
    'SP_VISEME_18', 'DISPID_SVGetProfiles',
    'DISPID_SRSetPropertyString', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SGRsCommit', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVSInputWordLength', 'SPPS_RESERVED2',
    'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE9',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SpeechLexicon',
    'SPSUnknown', 'SPAS_CLOSED', 'ISpRecognizer3',
    'DISPID_SRCEventInterests', 'SPPS_Noun',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRGRules', 'DISPID_SLWsItem',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRClear', 'SVEAudioLevel',
    'DISPID_SRCEPhraseStart',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGCmdLoadFromMemory', 'STSF_AppData',
    'DISPID_SPCPhoneToId', 'SVP_8', 'ISpeechObjectTokens',
    'ISpeechRecognizerStatus', 'SpeechVoiceEvents',
    'DISPID_SRSetPropertyNumber', 'SDKLLocalMachine',
    'SPWORDPRONUNCIATIONLIST', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechLexiconWord', 'SGLexical', 'DISPID_SRCESoundStart',
    'eLEXTYPE_RESERVED8', 'SpeechEngineProperties',
    'DISPID_SRCRequestedUIType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_RESERVED10', 'IEnumString',
    'DISPID_SABIMinNotification', 'DISPID_SOTs_NewEnum',
    'SSSPTRelativeToStart', 'SpInprocRecognizer', 'SVP_20',
    'SRCS_Enabled', 'SpeechPropertyHighConfidenceThreshold',
    'STSF_CommonAppData', 'DISPID_SVEViseme', 'SWTDeleted',
    'DISPID_SRCPause', 'SAFT16kHz16BitMono',
    'DISPID_SpeechPhraseRule', 'SITooLoud', 'SAFT32kHz8BitStereo',
    'ISpRecoCategory', 'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE17',
    'SpMMAudioIn', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRRGetXMLResult',
    'DISPID_SRCVoice', 'SAFTExtendedAudioFormat', 'SVP_13',
    'DISPID_SASetState', 'SpVoice', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRGCmdLoadFromObject',
    'ISequentialStream', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SMSAMMHandle', 'SPEI_RESERVED5', 'eLEXTYPE_PRIVATE3',
    'SpObjectToken', 'SPRECORESULTTIMES', 'ISpeechGrammarRule',
    'SpeechCategoryVoices', 'SECFIgnoreKanaType', 'SpeechLexiconType',
    'DISPID_SPARecoResult', 'DISPID_SPIGetText',
    'SPINTERFERENCE_TOOSLOW', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechFileStream', 'DISPID_SPRText', 'ISpeechRecoResult2',
    'DISPID_SPPConfidence', 'SPSHT_Unknown', 'DISPID_SRGRecoContext',
    'SPAO_NONE', 'SPAUDIOOPTIONS', 'DISPID_SGRsItem',
    'DISPID_SPRsCount', 'ISpeechObjectToken', 'SVP_9',
    'DISPID_SLPsItem', 'SPFM_OPEN_READWRITE', 'SPDKL_DefaultLocation',
    'SVP_7', 'ISpStreamFormatConverter', 'WAVEFORMATEX',
    'ISpeechVoiceStatus', 'SAFTADPCM_22kHzStereo', 'SPSInterjection',
    'SpeechPartOfSpeech', 'SASPause', 'DISPID_SPIRule',
    'DISPID_SASState', 'SVP_3', 'eLEXTYPE_PRIVATE6',
    'ISpeechRecoResultTimes', 'SPBO_PAUSE',
    'DISPID_SPRuleEngineConfidence', 'SpeechVoicePriority',
    'SPEI_SENTENCE_BOUNDARY', 'ISpRecoContext',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVEWord', 'SPSSuppressWord', 'SPWORDPRONOUNCEABLE',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechBaseStream',
    'SpeechMicTraining', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechMemoryStream', 'SPPS_Unknown', 'SPPHRASE',
    'ISpPhoneConverter', 'SVEStartInputStream', 'DISPID_SRStatus',
    'SpeechGrammarTagUnlimitedDictation', 'SPPS_RESERVED1',
    'SPFM_CREATE', 'SVESentenceBoundary', 'SPEI_PHONEME',
    'DISPID_SpeechRecoResult2', 'SP_VISEME_9',
    'SpeechDataKeyLocation', 'SPEI_UNDEFINED', 'DISPID_SAVolume',
    'SAFT24kHz16BitMono', 'SDTReplacement',
    'DISPIDSPTSI_ActiveOffset', 'ISpGrammarBuilder',
    'DISPID_SOTCSetId', 'SPWORDLIST', 'SpeechPropertyResponseSpeed',
    'SVP_6', 'DISPID_SVResume', 'SAFTText', 'Speech_Default_Weight',
    'DISPID_SOTCGetDataKey', 'SP_VISEME_17', 'ISpEventSink',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE8',
    'SPINTERFERENCE_TOOQUIET', 'SPWT_DISPLAY', 'SPCT_COMMAND',
    'SpeechTokenKeyFiles', 'SPWF_INPUT', 'SpeechGrammarState',
    'DISPID_SOTGetAttribute', 'DISPID_SDKSetLongValue',
    'SpPhoneticAlphabetConverter', 'eLEXTYPE_USER',
    'SAFT11kHz16BitStereo', 'DISPID_SVSpeak', 'eLEXTYPE_RESERVED6',
    'DISPID_SLWLangId', 'SpStreamFormatConverter', 'SPSLMA',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechAudioFormat', 'DISPID_SPRuleFirstElement',
    'DISPID_SPRsItem', 'DISPID_SMSSetData', 'STCInprocServer',
    'DISPID_SPAPhraseInfo', 'SP_VISEME_2', 'SRADynamic',
    'SPBO_TIME_UNITS', 'SAFT32kHz16BitMono', 'SAFT44kHz16BitStereo',
    'SpeechPropertyLowConfidenceThreshold', 'SVEVoiceChange',
    'DISPID_SLAddPronunciation', 'SREHypothesis',
    'SpeechCategoryAudioOut', 'DISPID_SRSAudioStatus', 'SRSInactive',
    'DISPID_SVPause', 'DISPID_SPRs_NewEnum', 'SPPS_RESERVED4',
    ...
    'DISPID_SVEAudioLevel', 'SPWAVEFORMATTYPE', 'SAFT8kHz16BitMono',
    ...
    'DISPID_SRCCreateResultFromMemory', 'SPCONTEXTSTATE',
    'SAFT12kHz16BitStereo', 'SAFTCCITT_ALaw_8kHzStereo',
    'STCRemoteServer', 'SREAdaptation', 'SVP_21', 'DISPID_SVEPhoneme',
    'SPEI_VOICE_CHANGE', 'ISpeechVoice', 'SDTLexicalForm', 'SPRULE',
    'ISpPhraseAlt', 'ISpeechPhraseRule',
    'DISPID_SRCSetAdaptationData', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPEI_END_SR_STREAM', 'DISPID_SAEventHandle',
    'DISPID_SLWPronunciations', 'SRAORetainAudio',
    'DISPID_SASCurrentDevicePosition', 'SPSERIALIZEDPHRASE',
    'SVSFParseMask', 'SPTEXTSELECTIONINFO', 'SpeechAddRemoveWord',
    'SPBO_NONE', 'SP_VISEME_4', 'SpeechCategoryAppLexicons',
    'DISPID_SRCEInterference', 'DISPID_SRCRetainedAudio',
    'DISPID_SBSSeek', 'DISPID_SASFreeBufferSpace', 'SPEI_SOUND_END',
    'DISPID_SpeechXMLRecoResult', 'SPBO_AHEAD',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRSNumberOfActiveRules',
    'ISpSerializeState', 'DISPID_SGRs_NewEnum',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SRTAutopause',
    'SPVPRIORITY', 'DISPID_SpeechRecoResultTimes', 'DISPID_SOTSetId',
    'DISPID_SPIReplacements', 'SpCustomStream', 'SASStop',
    'SPSHORTCUTTYPE', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechFormatType', 'SGSEnabled', 'UINT_PTR',
    'DISPID_SRCEEndStream', 'DISPID_SOTDataKey', 'SPVPRI_NORMAL',
    'DISPID_SpeechPhraseInfo', 'SPSEMANTICFORMAT',
    'DISPID_SpeechAudio', 'SpeechAudioVolume', 'SAFT16kHz16BitStereo',
    'SAFT44kHz16BitMono', 'DISPID_SDKEnumKeys', 'SAFT12kHz16BitMono',
    '_SPAUDIOSTATE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPFM_OPEN_READONLY', 'ISpeechLexiconPronunciations',
    'DISPID_SRRAudioFormat', 'SPEI_PHRASE_START',
    'DISPID_SpeechRecognizer', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPPsItem',
    'DISPID_SRCEAudioLevel', 'SP_VISEME_15', 'SP_VISEME_1',
    'SPEI_RECOGNITION', 'IInternetSecurityMgrSite',
    'DISPID_SPCIdToPhone', 'SLOStatic', 'SpeechWordPronounceable',
    'DISPID_SPERequiredConfidence', 'SAFT11kHz16BitMono',
    'DISPID_SDKEnumValues', 'DISPID_SRSSupportedLanguages',
    'DISPID_SPEPronunciation', 'SASClosed',
    'ISpeechPhraseReplacements', 'SPWORDTYPE', 'SPBOOKMARKOPTIONS',
    'tagSTATSTG', 'DISPID_SVSkip', 'DISPID_SRGSetTextSelection',
    'ISpeechXMLRecoResult', 'DISPID_SpeechRecoContext',
    'DISPID_SWFEExtraData', 'SLODynamic', 'SAFTADPCM_11kHzStereo',
    'SpeechCategoryPhoneConverters', 'SPSNotOverriden',
    'DISPID_SPELexicalForm', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE11', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRId', 'SAFTADPCM_44kHzMono', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SGRsAdd',
    'DISPID_SVVolume', 'ISpProperties', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SOTCDefault', 'SVEPrivate', 'DISPID_SLGetPronunciations',
    'DISPID_SRGReset', 'SRAImport', 'SRERecoOtherContext',
    'DISPID_SGRSTRule', 'SpeechStreamFileMode',
    'DISPID_SRRTTickCount', 'SVEViseme', 'SAFT11kHz8BitMono',
    'eLEXTYPE_PRIVATE13', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPEs_NewEnum', 'SVSFNLPMask', 'eLEXTYPE_APP',
    'SpeechPropertyComplexResponseSpeed', 'ISpObjectWithToken',
    'SPGRAMMARSTATE', 'DISPID_SRState', 'DISPID_SGRSTNextState',
    'DISPID_SGRsCount', 'SSFMOpenReadWrite',
    ...
    'DISPID_SVWaitUntilDone', 'SITooFast', 'DISPID_SGRSTsItem',
    'SVP_14', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SDKSetStringValue', 'ISpeechRecoResultDispatch',
    'ISpeechTextSelectionInformation', 'SRERecognition',
    'ISpeechAudioStatus', 'SpStream', 'SpNotifyTranslator',
    'SREPropertyStringChange', 'SPPHRASEPROPERTY', 'DISPID_SPAsItem',
    'SAFT48kHz16BitStereo', 'SPPS_Function',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_VISEME',
    'DISPID_SRGCmdSetRuleIdState', 'SGRSTTEpsilon', 'SRESoundStart',
    'DISPID_SVSLastBookmarkId', 'DISPID_SpeechVoiceEvent',
    'SAFTCCITT_uLaw_44kHzMono', 'SDTDisplayText',
    'DISPID_SPPs_NewEnum', 'SAFT24kHz16BitStereo', 'SREStreamStart',
    'SPEI_RESERVED6', 'SRSActiveAlways', 'SP_VISEME_19',
    'SPSERIALIZEDRESULT', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SLWType', 'DISPID_SVEStreamStart',
    'DISPID_SDKGetlongValue', 'SPBINARYGRAMMAR', 'SVP_16',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SpeechDataKey',
    'SPCT_SUB_DICTATION', 'SAFT8kHz8BitStereo', 'DISPID_SVSPhonemeId',
    'ISpeechGrammarRules', 'SREInterference',
    'DISPID_SRCEStartStream', 'SPSMF_UPS', 'DISPID_SGRSTransitions',
    'DISPID_SVStatus', 'SPPHRASERULE', 'DISPID_SPRNumberOfElements',
    'SLTUser', 'SPLEXICONTYPE', 'SP_VISEME_3',
    'DISPID_SpeechCustomStream', 'SPRS_ACTIVE',
    'DISPID_SPPFirstElement', 'SECFDefault', 'SVSFParseSsml',
    'DISPID_SLGetWords', 'SAFT32kHz16BitStereo', 'SpeechAudioState',
    'eLEXTYPE_PRIVATE1', 'eLEXTYPE_PRIVATE5', 'SDKLDefaultLocation',
    'SPLO_DYNAMIC', 'DISPID_SPACommit', 'SPVISEMES',
    'SPPS_Noncontent', 'DISPID_SOTRemove', 'ISpAudio',
    'SRADefaultToActive', 'ISpeechFileStream',
    'DISPID_SPRuleConfidence', 'SPEI_TTS_PRIVATE', 'DISPID_SRRAudio',
    'SVSFIsXML', 'SPPS_Interjection', 'SPWORDPRONUNCIATION',
    'DISPID_SpeechVoiceStatus', 'SpeechTokenKeyUI',
    'SpeechRecoEvents', 'SWPKnownWordPronounceable',
    'ISpeechCustomStream', 'SpShortcut', 'DISPID_SBSWrite',
    'SPPHRASEREPLACEMENT', 'ISpPhoneticAlphabetConverter',
    'ISpeechRecoContext', 'DISPID_SRGCommit', 'SpPhraseInfoBuilder',
    'SAFTCCITT_ALaw_44kHzStereo', 'SECHighConfidence',
    'DISPID_SPRulesCount', 'SVPOver', 'ISpLexicon', 'SPEVENTENUM',
    'SPSHT_OTHER', 'SVF_Emphasis', 'DISPID_SRRTStreamTime',
    'eLEXTYPE_PRIVATE2', 'ISpRecoGrammar', 'SITooQuiet',
    'SpeechVoiceSpeakFlags', 'DISPID_SRCRecognizer', 'SVSFPersistXML',
    'SPDKL_LocalMachine', 'SSTTWildcard', 'DISPID_SVVoice',
    'SP_VISEME_0', 'ISpNotifyTranslator', 'SPADAPTATIONRELEVANCE',
    'SDKLCurrentUser', 'DISPID_SDKOpenKey', 'SGDisplay',
    'DISPID_SVRate', 'DISPID_SOTsItem', 'ISpeechAudioFormat',
    'DISPID_SGRSTs_NewEnum', 'ISpeechObjectTokenCategory',
    'SPEI_MAX_SR', 'SGDSInactive', 'SREStateChange',
    'Speech_StreamPos_RealTime', 'SGDSActiveWithAutoPause',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SOTCId', 'ISpVoice',
    'SpeechCategoryRecognizers', 'DISPID_SPILanguageId',
    'DISPID_SPEEngineConfidence', 'DISPID_SPPParent', 'SRESoundEnd',
    'DISPID_SpeechGrammarRule', 'SpSharedRecoContext',
    'SpeechCategoryAudioIn', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRCBookmark', 'DISPID_SRGState', 'SVP_2',
    'DISPID_SVSpeakCompleteEvent', 'SPGRAMMARWORDTYPE', 'SVP_15',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPS_Modifier',
    'SGRSTTDictation', 'SDTAudio', 'DISPID_SRSCurrentStreamPosition',
    'SVEWordBoundary', 'SAFT48kHz8BitMono', 'SpeechRecognitionType',
    'STCLocalServer', 'DISPID_SVSVisemeId', 'DISPID_SRCEBookmark',
    'SPVOICESTATUS', 'SpInProcRecoContext', 'SVPAlert',
    'ISpeechRecognizer', 'SPEI_RESERVED1', 'DISPID_SRCERecognition',
    'DISPID_SLPType', 'SBOPause', 'DISPID_SLGenerationId',
    'DISPID_SAStatus', 'SPWT_PRONUNCIATION', 'SpeechRecoContextState',
    'SPRULESTATE', 'DISPID_SPPEngineConfidence',
    'SpeechAudioFormatType', 'SASRun', 'DISPID_SWFEFormatTag',
    ...
    'ISpEventSource', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechPhraseReplacement', 'SAFT44kHz8BitStereo',
    'DISPID_SGRSTsCount', 'DISPID_SPAStartElementInResult',
    'SGRSTTWord', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechRecoContextEvents', 'SpeechPropertyResourceUsage',
    'SPFILEMODE', 'ISpeechLexiconWord', 'SVP_1',
    'SpeechTokenKeyAttributes', 'DISPID_SRGDictationUnload',
    'SPLOADOPTIONS', 'ISpeechGrammarRuleState', 'ISpRecoGrammar2',
    'DISPID_SpeechPhraseReplacements', 'SVP_5', 'SLTApp',
    'ISpeechPhraseProperties', 'SDTAll', 'DISPID_SWFESamplesPerSec',
    'DISPID_SOTsCount', 'SpeechPropertyAdaptationOn',
    'SPRST_NUM_STATES', 'ISpeechAudio', 'SDA_Two_Trailing_Spaces',
    'DISPID_SWFEAvgBytesPerSec', 'SpMMAudioOut',
    'ISpeechPhraseReplacement', 'SP_VISEME_7',
    'DISPID_SAFSetWaveFormatEx', 'SPAR_Medium',
    ...
    'DISPID_SPIEngineId', 'SVSFNLPSpeakPunc', 'ISpeechWaveFormatEx',
    'SSFMCreate', 'DISPID_SGRsFindRule',
    ...
    'SPEI_RECO_STATE_CHANGE', 'SPWORD', 'ISpeechMemoryStream',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVSFUnusedFlags',
    'SpPhoneConverter', 'ISpPhoneticAlphabetSelection',
    'SGPronounciation', 'DISPID_SPEDisplayText', 'SPAS_PAUSE',
    'SPEI_START_INPUT_STREAM', 'STSF_FlagCreate',
    '_ISpeechVoiceEvents', 'Speech_Max_Word_Length',
    'DISPID_SRRDiscardResultInfo', 'eWORDTYPE_DELETED',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechTokenShellFolder',
    'eLEXTYPE_RESERVED9', 'DISPID_SRCEAdaptation', 'SPSNoun',
    'SPVPRI_OVER', 'SPEI_TTS_AUDIO_LEVEL', 'SVF_None',
    'DISPID_SOTGetStorageFileName', 'DISPID_SLPPhoneIds', 'SPAS_RUN',
    'DISPID_SGRSAddWordTransition', 'SAFT32kHz8BitMono',
    'SPAUDIOSTATE', 'SGDSActive', 'SVP_11',
    ...
    'ISpeechLexiconWords', 'DISPID_SMSALineId', 'SPEI_ADAPTATION',
    'SECFNoSpecialChars', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRCCreateGrammar', 'SpResourceManager',
    'SPSHORTCUTPAIRLIST', 'SAFT8kHz8BitMono', 'SRCS_Disabled',
    'DISPID_SPPValue', 'eLEXTYPE_PRIVATE7', 'SAFTADPCM_44kHzStereo',
    'SAFTGSM610_11kHzMono', 'IInternetSecurityManager',
    'DISPID_SGRSTPropertyValue', 'SAFTGSM610_44kHzMono', 'SRSActive',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPAO_RETAIN_AUDIO',
    'SGRSTTWildcard', 'SPSEMANTICERRORINFO', 'DISPID_SRRTimes',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCState',
    'ISpStreamFormat', 'eLEXTYPE_PRIVATE4', 'SAFT22kHz8BitStereo',
    'DISPID_SPEAudioTimeOffset', 'SpeechRuleState',
    'ISpeechPhraseInfo', 'SAFTCCITT_uLaw_11kHzMono',
    'Speech_StreamPos_Asap', 'DISPID_SpeechGrammarRules',
    'DISPID_SPIAudioSizeBytes', 'IEnumSpObjectTokens',
    'DISPID_SVGetAudioInputs', 'SPRST_INACTIVE', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechPhraseRules', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRGId', 'SPEI_RESERVED2', 'SpeechEmulationCompareFlags',
    'DISPID_SVEBookmark', 'DISPID_SVAlertBoundary', 'SPRECOSTATE',
    'SPRST_ACTIVE', 'SP_VISEME_12', 'Speech_Max_Pron_Length',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRPhraseInfo', 'LONG_PTR',
    'DISPID_SRRTLength', 'SWPUnknownWordUnpronounceable', 'SpLexicon',
    'SPINTERFERENCE_NOISE', 'SP_VISEME_14', 'STCInprocHandler',
    'SPRECOCONTEXTSTATUS', 'SPFM_NUM_MODES',
    'DISPID_SPEAudioSizeBytes', 'STSF_LocalAppData',
    'SAFT11kHz8BitStereo', 'DISPID_SpeechVoice',
    ...
    'ISpDataKey', 'SPEI_REQUEST_UI', 'SPSHORTCUTPAIR', 'SRTReSent',
    'DISPID_SRGetFormat', 'DISPID_SOTIsUISupported',
    'SpeechAllElements', 'DISPID_SGRsDynamic', 'DISPID_SWFEChannels',
    'SVPNormal', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPRS_ACTIVE_USER_DELIMITED', 'SRARoot', 'SpeechRunState',
    'DISPID_SOTCreateInstance', 'DISPID_SBSRead', 'ISpShortcut',
    'DISPID_SGRSTPropertyName', 'SPPARTOFSPEECH',
    'SpeechRecoProfileProperties', 'DISPID_SDKCreateKey',
    'ISpeechRecoGrammar', 'SVP_0', 'DISPID_SMSADeviceId',
    'DISPID_SpeechLexiconWords', 'SVP_12',
    'DISPID_SRCERecognizerStateChange', 'DISPIDSPRG',
    'SPPHRASEELEMENT', 'SDTRule', 'DISPID_SDKSetBinaryValue',
    'SAFT8kHz16BitStereo', 'DISPID_SRDisplayUI',
    'DISPID_SDKGetBinaryValue', 'SPRS_INACTIVE', 'SINone',
    'ISpRecognizer2', 'SPRST_INACTIVE_WITH_PURGE',
    'SpObjectTokenCategory', 'ISpeechRecoResult',
    'DISPID_SPANumberOfElementsInResult', 'SPPS_LMA',
    'DISPID_SABufferInfo', 'DISPID_SVESentenceBoundary',
    'SPSModifier', 'SRERequestUI', 'SREPropertyNumChange',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SLPsCount',
    'SPXMLRESULTOPTIONS', 'SPPS_NotOverriden',
    'DISPID_SRCreateRecoContext', 'DISPID_SPISaveToMemory',
    'DISPID_SPCLangId', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechObjectTokens', 'DISPID_SRGSetWordSequenceData',
    'SpeechUserTraining', 'SVEAllEvents', 'SpUnCompressedLexicon',
    'SGRSTTTextBuffer', 'DISPID_SVEventInterests', 'DISPID_SPPName',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPAs_NewEnum',
    'DISPID_SPEAudioStreamOffset', 'eLEXTYPE_PRIVATE16',
    'SpeechTokenContext', 'SP_VISEME_11', 'SBONone',
    'eLEXTYPE_PRIVATE19', 'DISPID_SGRSTPropertyId',
    'SpeechRetainedAudioOptions', 'DISPID_SOTDisplayUI',
    'DISPID_SVSInputSentenceLength', 'SGSExclusive', 'SPPS_RESERVED3',
    'SPEVENT', 'DISPID_SVAudioOutputStream', 'SPEI_INTERFERENCE',
    'SVSFIsNotXML', 'SPCATEGORYTYPE', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPIElements', 'SECLowConfidence', 'SAFTNonStandardFormat',
    'DISPID_SPRules_NewEnum', 'ISpeechResourceLoader', 'SVEBookmark',
    'DISPID_SRGDictationSetState', 'SPPROPERTYINFO', 'SRAONone',
    'SpeechVisemeType', 'SAFTCCITT_uLaw_22kHzMono',
    'SPINTERFERENCE_TOOLOUD', 'SpeechWordType',
    'DISPID_SPEActualConfidence', 'SRTEmulated', 'SPAR_High',
    'SPSMF_SAPI_PROPERTIES', 'SAFTDefault', 'DISPID_SGRAddState',
    'SP_VISEME_13', 'SAFTADPCM_8kHzMono', 'SRTExtendableParse',
    'SAFT48kHz8BitStereo', 'DISPID_SPPsCount', 'SPEI_TTS_BOOKMARK',
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE10', 'SPEI_START_SR_STREAM',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPAsCount', 'SPXRO_SML',
    'ISpXMLRecoResult', 'SREAudioLevel', 'DISPID_SLWs_NewEnum',
    'DISPID_SOTId', 'DISPID_SRRecognizer', 'DISPID_SVGetVoices',
    'SPAR_Low', 'SREStreamEnd', 'DISPID_SAFGetWaveFormatEx',
    'SVSFlagsAsync', 'DISPID_SVSLastStreamNumberQueued',
    'SP_VISEME_21', 'DISPID_SRSClsidEngine', 'SPSHT_EMAIL',
    'DISPID_SMSGetData', 'DISPID_SVSInputSentencePosition',
    'DISPID_SGRSTWeight', 'DISPID_SGRAddResource',
    'DISPID_SPIProperties', 'DISPID_SRRSaveToMemory',
    'DISPID_SPERetainedStreamOffset', 'ISpPhrase',
    'DISPID_SpeechObjectToken', 'SpMemoryStream',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechPhoneConverter',
    'SAFTADPCM_11kHzMono', 'ISpObjectToken', 'SPEI_SR_PRIVATE',
    'SAFT24kHz8BitMono', 'DISPID_SVDisplayUI', 'SECNormalConfidence',
    'ISpStream', 'SP_VISEME_6', 'DISPID_SPRuleParent',
    'DISPID_SGRSAddRuleTransition', 'SPSTREAMFORMATTYPE',
    'SREBookmark', 'SPEI_MAX_TTS', 'SAFT12kHz8BitStereo',
    'SPCT_SLEEP', 'DISPID_SAFGuid', 'SITooSlow', 'SPSVerb',
    ...
    'ISpeechLexicon', 'SDTProperty', 'DISPID_SPRuleId',
    'SAFT44kHz8BitMono', 'SpeechInterference', 'DISPID_SPEsItem',
    'SpeechEngineConfidence', 'SpeechSpecialTransitionType',
    'ISpeechPhraseRules', 'SpeechTokenIdUserLexicon', 'SRAExport',
    'ISpObjectTokenCategory', 'SAFT16kHz8BitStereo', 'SPAUDIOSTATUS',
    'SpNullPhoneConverter', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechLoadOption', 'DISPID_SRProfile', 'ISpeechPhraseElement',
    'SPPS_Verb', 'SWPUnknownWordPronounceable', '_RemotableHandle',
    'SpeechRecognizerState', 'SRSEDone', 'SPINTERFERENCE_TOOFAST',
    'SDA_No_Trailing_Space', 'DISPID_SVEVoiceChange', 'SPCS_ENABLED',
    'DISPID_SPRuleNumberOfElements', 'SAFTCCITT_uLaw_8kHzStereo',
    'SVP_19', 'SDA_Consume_Leading_Spaces', 'DISPID_SAFType',
    'DISPID_SABIBufferSize', 'DISPID_SGRName', 'SVF_Stressed',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRAudioInput',
    'SRTSMLTimeout', 'DISPID_SCSBaseStream',
    'DISPID_SpeechWaveFormatEx', 'SVSFDefault',
    'DISPID_SVAudioOutput', 'SRATopLevel', 'SAFT48kHz16BitMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SVSRunningState',
    'DISPID_SRRGetXMLErrorInfo', 'SREAllEvents',
    'DISPID_SPRuleChildren', 'SVP_4', 'DISPID_SpeechPhraseElement',
    'DISPID_SPIRetainedSizeBytes', 'SAFT22kHz16BitMono',
    'SREFalseRecognition', 'SPWF_SRENGINE',
    'DISPID_SpeechAudioBufferInfo', 'SP_VISEME_10',
    'DISPID_SGRSTText', 'SPWT_LEXICAL', 'DISPID_SVGetAudioOutputs',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SABufferNotifySize',
    'SpAudioFormat', 'SRSEIsSpeaking', 'DISPID_SRIsShared',
    'SpeechAudioFormatGUIDText', 'DISPID_SPPId',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechDataKey',
    'ISpNotifySink', 'SpeechGrammarTagWildcard', 'SECFIgnoreWidth',
    ...
    'DISPID_SRCEEnginePrivate', 'SVEPhoneme', 'DISPID_SRCESoundEnd',
    'DISPID_SRGCmdLoadFromResource', 'SDKLCurrentConfig',
    'SRAInterpreter'
]

_check_version('1.1.14', 1662363873.488811)
